...
// WIFI
// ==============================
const char* ssid     = "Viccxi Musisi Sukses";   // ganti SSID Anda
const char* password = "paidiwir";               // ganti password Anda

// ==============================
// SERVER  (ganti IP sesuai MAMP)
// ==============================
const char* serverTap    = "http://10.19.189.16/PRESENSI/php/tap.php";
const char* serverSaveUID = "http://10.19.189.16/PRESENSI/php/save_uid.php";
const char* serverStatus  = "http://10.19.189.16/PRESENSI/php/status.php";
